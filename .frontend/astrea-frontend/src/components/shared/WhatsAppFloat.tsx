...
const WhatsAppFloat: React.FC = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg shadow-green-500/25 transition-all duration-200"
